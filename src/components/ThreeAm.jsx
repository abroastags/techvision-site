      ...
      <div className="tv-section">
        ...
        <div className="tv-3am__cols">
          <div className="tv-3am__col">
            <div className="tv-eyebrow tv-3am__eyebrow"><span aria-hidden="true">▾</span><span>Lifecycle</span></div>
            <p>Requirements, architecture, code, QA, deployment, and the on-call shift when something breaks at 3am — one team, one P&amp;L.</p>
          </div>
          <div className="tv-3am__col">
            <div className="tv-eyebrow tv-3am__eyebrow"><span aria-hidden="true">▾</span><span>On-call</span></div>
          ...
          <div className="tv-3am__col">
            <div className="tv-eyebrow tv-3am__eyebrow"><span aria-hidden="true">▾</span><span>Where we sit</span></div>
